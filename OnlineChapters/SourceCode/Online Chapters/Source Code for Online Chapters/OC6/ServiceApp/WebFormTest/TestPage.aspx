...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Invoke" runat="server" Text="Invoke" OnClick="Invoke_Click" />
            <asp:Button ID="InvokeContract" runat="server" Text="Contract" OnClick="InvokeContract_Click" /><br />
